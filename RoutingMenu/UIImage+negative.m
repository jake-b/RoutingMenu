...
- (NSImage *)negativeImage
{
    ...
    CGContextDrawImage(context, CGRectMake(0, 0, width, height), [self CGImageForProposedRect:<#(nullable NSRect *)#> context:<#(nullable NSGraphicsContext *)#> hints:<#(nullable NSDictionary<NSString *,id> *)#>]);
